...
const graph = {
  ...
  edges: [
    ...
    {to: 3, from: 0, label: 'Member Of'},
    {to: 4, from: 0, label: 'Member Of'},
    {to: 5, from: 0, label: 'Member Of'},
    {to: 7, from: 6, label: 'Member Of'},
    {to: 8, from: 6, label: 'Member Of'},
    ...
    {to: 4, from: 39, label: 'Member Of'},
    {to: 42, from: 39, label: 'Member Of'},
    {to: 43, from: 39, label: 'Member Of'},
    {to: 4, from: 44, label: 'Member Of'},
    {to: 42, from: 44, label: 'Member Of'},
    {to: 41, from: 44, label: 'Member Of'},
    {to: 40, from: 44, label: 'Member Of'},
